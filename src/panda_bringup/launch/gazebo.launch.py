...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package='panda_bringup').find('panda_bringup')
    ...
    effort_controller_config = os.path.join(
        get_package_share_directory("panda_bringup"), "config", "ros_control.yaml"
    )
