...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='panda_motion_planning',
            executable='panda_motion_planning',
            output='screen',
            parameters=[{
                'use_sim_time': True
            }]
        ...
        Node(
            package='panda_object_detection',
            executable='red_object_detection',
            output='screen',
            parameters=[{
                'use_sim_time': True
            }]
        ...
        TimerAction(
            ...
            actions = [Node(
                package='panda_motion_planning',
                executable='camera_based_pick_and_place',
                output='screen',
                parameters=[{
                    'use_sim_time': True
                }]
